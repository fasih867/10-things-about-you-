    ...
    card.innerHTML = `
      <div class="card-inner">
        <div class="face front">
          ...
          <p class="subtitle">He was put into the spotlight yesterday and feels like he didn't do a great job telling her what he appreciates about her, and what makes him feel the most content that she has these qualities in her.<br><br>Sooo here areee 10 things that he loves about her, and he thinks she should know them.</p>
    ...
    card.innerHTML = `
      <div class="card-inner">
        ...
        <div class="face back">
          ...
          <span class="tap">swipe for next →</span>
        </div>
      </div>`;
    counter.textContent = `${index} / 10`;
    hint.textContent = "tap card to reveal • swipe for next";
  }
